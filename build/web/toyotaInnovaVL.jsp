                        ...
                        <div class="frame">
                            <div class="overlap-group">
                                    ...
                                    <div class="group-wrapper">
                                        <div class="group">
                                            <div class="flexcontainer">
                                                <p class="text">
                                                    <span class="span">TYPE:</span> <span class="text-wrapper-4"> MPV<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">DISPLACEMENT:</span>
                                                    <span class="text-wrapper-4"> 2755cc<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">TRANSMISSION:</span> <span class="text-wrapper-4"> Manual<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">FUEL TYPE:</span> <span class="text-wrapper-4"> Diesel<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">FUEL CAPACITY:</span> <span class="text-wrapper-4"> 55 Liters<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">NUMBER OF SEATS: </span> <span class="text-wrapper-4">8<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">PRICE:</span> <span class="text-wrapper-4"> 2,500 PHP / DAY<br /></span>
                                                </p>
                                ...
                                <img
                                    ...
                                    />
                                <div class="overlap-3">
                                    <div class="text-wrapper-6">TOYOTA INNOVA</div>
