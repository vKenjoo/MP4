                        ...
                        <div class="frame">
                            <div class="overlap-group">
                                    ...
                                    <div class="group-wrapper">
                                        <div class="group">
                                            <div class="flexcontainer">
                                                <p class="text">
                                                    <span class="span">TYPE:</span> <span class="text-wrapper-4"> Pickup<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">DISPLACEMENT:</span>
                                                    <span class="text-wrapper-4"> 2477cc<br /></span>
                                                </p>
                                                <p class="text">
                                                ...
                                                <p class="text">
                                                    <span class="span">FUEL CAPACITY:</span> <span class="text-wrapper-4"> 75 Liters<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">NUMBER OF SEATS: </span> <span class="text-wrapper-4">5<br /></span>
                                                </p>
                                                <p class="text">
                                                    <span class="span">PRICE:</span> <span class="text-wrapper-4"> 2300 PHP / DAY<br /></span>
                                                </p>
                                ...
                                <img
                                    ...
                                    />
                                <div class="overlap-3">
                                    <div class="text-wrapper-6">MITSUBISHI STRADA</div>
